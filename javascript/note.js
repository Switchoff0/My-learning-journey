...
let replaceMethod = "Here is an example of \"replace\" method";
let replaceExample = replaceMethod.replace("Here" ,"There");
console.log(replaceExample);
let repeatMethod = "Here is an example of \"repeat\" method.";
console.log(repeatMethod.repeat(2));
//console.log(repeatMethod.repeat(-2));
console.log(repeatMethod.repeat(0));
let repeatTimes = 2;
